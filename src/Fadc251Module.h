#ifndef Fadc251Module_
#define Fadc251Module_
...
class Fadc251Module : public VmeModule {

public:

   Fadc251Module() {};
   Fadc251Module(Int_t crate, Int_t slot);
   virtual ~Fadc251Module();
   ...
   Bool_t IsSampleMode() const { return (f251_setmode == F251_SAMPLE); };
   Bool_t IsIntegMode() const { return (f251_setmode == F251_INTEG); };

private:

   enum { F251_SAMPLE = 1, F251_INTEG = 2 };  // supported modes
   Int_t f251_setmode, f251_foundmode;
...
// Loads sldat and increments ptr to evbuffer
   ...
   ClassDef(Fadc251Module,0)  //  JLab FADC 251 Module
